...
class DbFixture:
    ...
    def get_contact_list(self):
        ...
        try:
            cursor.execute(
                "select id, firstname, middlename, lastname, nickname, company, title, address, home, mobile, work, fax, email, email2, email3, phone2 from `addressbook` where deprecated='0000-00-00 00:00:00'")
            for row in cursor:
